...
const About = () => {
  ...
  // About section images from Cloudinary
  const aboutImages = {
      ...
      <div className={styles.aboutContent}>
        ...
        <div className={styles.aboutGrid}>
          <div className={styles.aboutCard}>
            <img 
              src={getOptimizedImageUrl(aboutImages.asset1)} 
          ...
          <div className={styles.aboutCard}>
            ...
            <img 
              src={getOptimizedImageUrl(aboutImages.asset2)} 
              alt="Team working" 
              className={styles.aboutImage}
              loading="lazy"
            />
          ...
          <div className={styles.aboutCardFull}>
            <img 
              src={getOptimizedImageUrl(aboutImages.asset3)} 
